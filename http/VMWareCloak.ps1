...
$process_list = "vm3dservice", "VGAuthService", "VMwareService", "Vmwaretray", "Vmwareuser", "TPAutoConnSvc"
...
Write-Output "** Spot any bugs or issues? DM me on Twitter or open an issues on Github (https://github.com/d4rksystem/VMwareCloak/issues) ! :)"
